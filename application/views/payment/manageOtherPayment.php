...
<div class="content-box-content">
    ...
    <?php 
		if ($action == 'edit')
		{ 
			echo form_open_multipart('payment/manageOtherPayment/' . $id, array('id' => 'other_payment_input_form'));
		...
		{ 
			echo form_open_multipart('payment/manageOtherPayment', array('id' => 'other_payment_input_form')); 
	...
	?>
       ...
       <fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
            <p>
                ...
                <?php echo form_input(array('name' => 'expense_name', 'id' => 'expense_name', 'class' => 'text-input small-input', 'maxlength' => '60', 'value' => isset($expense_name) ? $expense_name : set_value('expense_name'))) ?>
                <?php echo form_error('expense_name', '<span class="input-notification error png_bg">', '</span>') ?>
            </p>
