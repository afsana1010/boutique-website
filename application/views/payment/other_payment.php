...
<?php if (isset($all_payment['payment_afterPg']) && $num_of_payments > 0) : ?>
                ...
                <table id="payment_table" class='tablesorter'>
                    <thead>
                        <tr>
                            ...
                            <th><a href="javascript:void(0);">Over Head Expence</a></th>
                        ...
                        <tr>
                            <td colspan="8">
                                <div class="bulk-actions align-left">
                                    <!--<a class="button" id="delete_payments" href="javascript:void(0)" onclick="delete_checked_payments();">Delete selected</a>&nbsp;-->
                                    <a href="payment/manageOtherPayment" class="button">Add New Payment</a>
                                </div>
    ...
    <?php foreach ($all_payment['payment_afterPg'] as $rows_payment) : ?>
                            <tr>
                                ...
                                <td><?php echo $rows_payment->expense_name ?></td>
