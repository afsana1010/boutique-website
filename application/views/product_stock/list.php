<?php
if (isset($all_stock['staff_afterPg'])) :
    $num_of_stocks = count($all_stock['stock_afterPg']);
endif;
?>
...
<?php if (isset($all_stock['stock_afterPg']) && $num_of_stocks > 0) : ?>
    ...
    <?php echo $stock_paging; ?>
                    ...
                    <tbody>
    <?php foreach ($all_stock['stock_afterPg'] as $rows_stock) : ?>
                            <tr>
...
<?php else : ?>
            ...
            <div class="clear"></div>
            <a href="stock_product/manage" class="button">Add New Stock</a>
<?php endif ?>
    </div>        
</div>