            ...
            <?php if ($ul_count == 1): ?>
                ...
                <li class="span3">
                    ...
                    if (count($image_data) > 0) :
                        ...
                        <br />
                        <a href="#photo_<?php echo $row->id ?>" data-toggle="modal">
                            <small>original photo&nbsp;|&nbsp;</small>
                        </a>
            <?php endif ?>
            ...
            <?php if ($img_flag == 1) : ?>
                        ...
                        <div class="modal hide fade" id="photo_<?php echo $row->id ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                            ...
                            <div class="modal-body">
                                <img id="product_image_<?php echo $row->id ?>" src="assets/uploads/product_images/<?php echo $image_files[0] ?>" height="50"  />
                                <?php if (count($image_files) > 1): ?>
                                    <center>
                                        <?php for ($i = 1; $i < count($image_files); $i++): ?>
                                            <?php echo $image_files[$i] ?>&nbsp;
<!--                                            <img class="product_other_image" height="50" src="assets/uploads/product_images/<?php //echo $image_files[$i] ?>"/>&nbsp;-->
                                        <?php endfor ?>
                                    </center>
                                <?php endif ?>
                            </div>
