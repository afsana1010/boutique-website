    ...
    <?php endif ?>
       ...
       <fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
			...
			<p>
                ...
                <?php echo form_input(array('name' => 'delivered_on', 'id' => 'delivered_on', 'class' => 'text-input small-input', 'maxlength' => '100', 'value' => isset($delivered_on) ? $delivered_on : set_value('delivered_on'))) ?>
                <?php echo form_error('delivered_on', '<span class="input-notification error png_bg">', '</span>') ?>
            </p>
			<?php endif ?>
