...
<div class="content-box-content">
    <div class="tab-content default-tab">
        ...
        ?>
        <?php if ($current_controller == 'profitandloss' && $current_method == 'selection_date' && $method_name=='profitandloss'):?>
        <?php echo form_open('profitandloss/profitandloss_statement/', array('id' => 'profitandloss_input_form')) ?>        
        <?php endif;?>
