...
<div class="content-box-content">
    <div class="tab-content default-tab">
        ...
        <fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
            ...
            <p>
                <label for="unit_price">Unit Price(SGD) </label> 
                <?php echo form_input(array('name' => 'unit_price', 'id' => 'unit_price', 'class' => 'text-input small-input', 'value' => isset($unit_price) ? $unit_price : set_value('unit_price'))) ?>
                <?php echo "<br /><small>should be a decimal value like 150.45, 99.99, etc.</strong></small>" ?>
                <?php echo form_error('unit_price', '<span class="input-notification error png_bg">', '</span>') ?>
            </p>
            ...
            <p>
                ...
                <?php if ((isset($is_active)) && ($is_active == 0)) : ?>
					<?php echo form_radio(array('name' => 'is_active', 'id' => 'is_active', 'value' => '1')) . '&nbsp;Active&nbsp;&nbsp;' ?>
					<?php echo form_radio(array('name' => 'is_active', 'id' => 'is_active', 'value' => '0', 'checked' => 'checked')) . 'Inactive' ?>
                <?php elseif ((isset($is_active)) && ($is_active == 1)) : ?>
					<?php echo form_radio(array('name' => 'is_active', 'id' => 'is_active', 'value' => '1', 'checked' => 'checked')) . '&nbsp;Active&nbsp;&nbsp;' ?>
					<?php echo form_radio(array('name' => 'is_active', 'id' => 'is_active', 'value' => '0')) . 'Inactive' ?>
                <?php else : ?>
					<?php echo form_radio(array('name' => 'is_active', 'id' => 'is_active', 'value' => '1')) . '&nbsp;Active&nbsp;&nbsp;' ?>
					<?php echo form_radio(array('name' => 'is_active', 'id' => 'is_active', 'value' => '0', 'checked' => 'checked')) . 'Inactive' ?>
                <?php endif ?>
