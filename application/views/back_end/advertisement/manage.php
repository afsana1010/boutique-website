	...
	?>
       ...
       <fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
			...
			<p>
                ...
                <?php echo form_input(array('name' => 'run_from', 'id' => 'run_from', 'class' => 'text-input small-input', 'maxlength' => '60', 'value' => isset($run_from) ? $run_from : set_value('run_from'))) ?>
                <?php //echo "<br /><small>provide the sellr's name or the company name from where you purchased the product</strong></small>" ?>
                <?php echo form_error('run_from', '<span class="input-notification error png_bg">', '</span>') ?>
            </p>
   		
			<p>
                <label for="image_file_path">Upload Image</label>
                <?php echo form_input(array('name' => 'image_file_path', 'id' => 'image_file_path', 'type'=>'file','class' => 'text-input medium-input', 'maxlength' => '60', 'value' => isset($image_file_path) ? $image_file_path : set_value('image_file_path'))) ?>
                <?php //echo "<br /><small>provide the sellr's name or the company name from where you purchased the product</strong></small>" ?>
                <?php echo form_error('image_file_path', '<span class="input-notification error png_bg">', '</span>') ?>
            </p>
			...
			<p>
                ...
                <?php echo form_textarea(array('name' => 'description', 'id' => 'description', 'class' => 'textarea wysiwyg', 'cols'=>'25', 'rows' => '10', 'value' => isset($description) ? $description : set_value('description'))) ?>
                <?php //echo "<br /><small>provide the sellr's name or the company name from where you purchased the product</strong></small>" ?>
