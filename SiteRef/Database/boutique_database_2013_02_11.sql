...
CREATE TABLE `boutique_categories` (
  ...
  CONSTRAINT `FK_boutique_category_sections` FOREIGN KEY (`product_section_id`) REFERENCES `boutique_product_sections` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=latin1;

/*Data for the table `boutique_categories` */

insert  into `boutique_categories`(`id`,`name`,`product_section_id`,`created_at`) values (1,'Bags',2,'2012-09-28'),(3,'Shoe',1,'2012-09-30'),(4,'Skirts & Tops',3,'2013-01-01'),(5,'Sunglasses',2,'2013-01-01'),(6,'School Bags',3,'2013-01-15'),(7,'Mini Skirts',3,'2013-01-15'),(8,'Suits',1,'2013-01-15'),(9,'Blazers',1,'2013-01-15'),(10,'Shoe',1,'2013-01-15'),(11,'School Accessories',3,'2013-01-23');
...
insert  into `boutique_messages`(`id`,`action_name`,`message`,`message_media`,`created_at`,`modified_at`) values (1,'START GREETING','Dear NAME,','both','2012-12-24 08:07:50','2012-12-24 08:19:09'),(2,'ACCOUNT ACTIVATION','Welcome to COMPANY. Checkout your mobile phone to get the SMS from us with a 4-digit activation code. Then go to the following link and submit the code to complete registration.','email','2012-12-24 08:25:35','2012-12-25 06:26:48'),(3,'SHIPMENT STATUS','Your shipment of the consignment NUMBER has been sent through COURIER on DATE.','email','2012-12-24 08:27:00',NULL),(5,'ORDER CONFIRMATION','You have successfully placed an order in COMPANY. Check email for details. Your order track id is NUMBER.','both','2012-12-24 08:36:38',NULL),(7,'SHIPMENT CLOSED','Your shipment of the consignment NUMBER has been delivered on DATE.','both','2012-12-24 08:45:54',NULL),(8,'END GREETING','--Boutique','both','2012-12-24 08:47:46',NULL),(9,'ORDER INFO TO ADMIN','The following order is placed by the user NAME. Please take all the neccessary steps.','email','2012-12-24 08:50:35',NULL),(12,'SMS 2FA','Please check your mailbox to get the activation link. Click the link and type 2FA in the input box to complete registration.','sms','2012-12-25 06:33:18',NULL);
...
insert  into `boutique_other_payments`(`id`,`expense_name`,`amount`,`bill_no`,`payment_date`,`mode_of_payment`,`payment_cheque_id`,`paypal_transaction_id`,`created_at`,`modified_at`) values (3,'Employee Salaray for October, 2012','2500.00',190601513,'2012-11-05','cash',0,0,'2012-11-11 05:00:38',NULL),(4,'Needle Machine','800.00',882392257,'2012-10-20','cheque',1,0,'2012-11-11 05:02:45',NULL);
...
insert  into `boutique_payment_cheques`(`id`,`account_no`,`account_name`,`bank_name`,`bank_branch`,`cheque_issue_date`,`created_at`,`modified_at`) values (1,'147852','Salma Begum','Standard Chartered','Uttara','2012-10-25','2012-11-11 05:02:45',NULL);
...
insert  into `boutique_product_images`(`id`,`product_id`,`category_id`,`file_name`,`dimension`,`uploaded_at`,`image_order`) values (3,7,1,'5071dad98aba1.jpg','140X140','2012-10-07 09:41:22',1),(4,8,3,'50723cef57bd0.jpg','193X148','2012-10-08 04:39:59',1),(6,5,1,'50843548c65d5.jpg','140X140','2012-10-21 07:50:32',1),(7,9,1,'5084360a31976.jpg','140X140','2012-10-21 07:51:11',1),(8,6,1,'508436273567f.jpg','500X579','2012-10-21 07:51:39',1),(9,7,1,'5071dab1dad5e.jpg','X','2012-10-23 03:59:31',2),(10,8,3,'50723cef76418.jpg','X','2012-10-23 03:59:48',1),(11,10,3,'5085fc370040c.jpg','562X400','2012-10-23 04:10:17',1),(12,5,1,'50ddce9b6731f.jpg','287X300','2012-12-28 05:53:56',2),(13,5,1,'50ddce9b85b66.jpg','300X225','2012-12-28 05:53:56',3),(15,12,4,'50e2559913d81.jpg','600X600','2013-01-01 04:18:53',1),(16,13,4,'50e2560da0fce.jpg','600X600','2013-01-01 04:20:49',1),(26,11,4,'50e31a768b28f.jpg','600X600','2013-01-01 06:18:52',1),(27,11,4,'50e31bb442ae4.jpg','600X600','2013-01-01 06:24:15',2),(28,11,4,'50e31bb45991b.jpg','600X600','2013-01-01 06:24:15',3),(29,11,4,'50e31bb47fb74.jpg','600X600','2013-01-01 06:24:15',4),(30,11,4,'50e31bb52429c.jpg','600X600','2013-01-01 06:24:15',5),(31,15,1,'50e34df3d3a3a.jpg','600X600','2013-01-01 09:58:36',2),(32,15,1,'50e34df3ee579.jpg','600X600','2013-01-01 09:58:36',1),(33,15,1,'50e34df41c88b.jpg','600X600','2013-01-01 09:58:36',3),(34,16,4,'50e34e0ec831f.jpg','600X600','2013-01-01 09:59:51',1),(35,17,1,'50e34e905991a.jpg','600X600','2013-01-01 10:01:07',1);
...
insert  into `boutique_product_sections`(`id`,`name`,`is_active`,`created_at`,`modified_at`) values (1,'men',1,'2013-01-23 08:41:48',NULL),(2,'women',1,'2013-01-23 08:45:13','2013-01-23 08:51:15'),(3,'kids',0,'2013-01-23 08:50:26','2013-01-23 09:03:50'),(4,'adult',0,'2013-01-23 09:04:10','2013-01-23 09:06:47');
...
insert  into `boutique_products`(`id`,`category_id`,`product_stock_id`,`product_name`,`product_no`,`guarantee`,`guarantee_unit`,`available_quantity`,`unit_price`,`description`,`is_active`,`created_at`,`modified_at`) values (5,1,1,'BAG-1','B001',24,'month',15,'350.00','This is a test Bag',1,'2012-10-07 08:17:15','2012-12-28 05:53:56'),(6,1,1,'BAG-2','B002',1,'month',98,'475.00','This is a test Bag-2',1,'2012-10-07 08:31:53','2012-10-23 03:59:03'),(7,1,2,'Purse-1','H001',24,'month',13,'280.00','This is a purse bg',1,'2012-10-07 08:35:28','2012-10-23 03:59:31'),(8,3,7,'High Hills','H001',7,'month',10,'250.00','These are test Hill product',1,'2012-10-07 08:50:28','2012-10-23 10:10:42'),(9,1,2,'BAG-2','B001',1,'week',15,'285.00','This is a test Bag',1,'2012-10-07 09:26:33','2012-10-23 03:58:44'),(10,3,8,'Colorful Boot','P174',24,'month',4,'650.00','Ladies first impression in a bar, party, horse-ranche, sports occassion...',1,'2012-10-23 04:10:16',NULL),(11,4,7,'Black Frock with Golden Spots','SK001',24,'month',120,'450.00','Elastic in the middle. Non-washable silky.',1,'2013-01-01 04:17:03','2013-01-01 06:24:14'),(12,4,7,'Pink & Silky Gown','SK002',12,'month',89,'275.00','Smooth and comfortable for night dress',1,'2013-01-01 04:18:53',NULL),(13,4,9,'School Skirt','SK003',12,'month',150,'200.00','School wear looks good with any white tops',1,'2013-01-01 04:20:49',NULL),(15,4,5,'Stylish Tops','SK004',24,'month',60,'14.98','Some details on Tops',1,'2013-01-01 09:58:04','2013-01-01 10:02:34'),(16,4,5,'White Creamy Tops','SK005',12,'month',15,'18.75','Silky and smooth',1,'2013-01-01 09:59:51',NULL),(17,4,5,'Orange Stripe Tops','SK006',24,'month',14,'35.75','Some details on Tops',1,'2013-01-01 10:01:07','2013-01-01 10:02:56');
...
insert  into `boutique_shopping_cart`(`id`,`product_id`,`user_id`,`quantity`,`item_chosen_at`) values (8,12,20,1,'2013-01-01 04:31:59'),(9,10,20,2,'2013-01-01 04:59:39');
...
insert  into `boutique_temporary_activation_codes`(`id`,`user_email`,`activation_code`) values (1,'sales@universalsigning.com','2441'),(2,'sales@universalsigning.com','8393');
...
insert  into `boutique_user_orders`(`id`,`user_id`,`product_id`,`shipment_level_id`,`order_quantity`,`bill_no`,`order_date`,`is_open`,`courier_name`,`courier_no`,`delivered_on`,`created_at`,`modified_at`) values (1,20,6,3,21,163908918,'2012-10-22',0,'DHL','147852','2012-12-10 00:00:00','2012-10-22 10:46:02',NULL),(2,20,8,2,2,423315295,'2012-10-23',1,'FedEx','258753',NULL,'2012-10-23 11:03:34',NULL),(3,20,10,1,2,423315295,'2012-10-23',1,NULL,NULL,NULL,'2012-10-23 11:03:35',NULL),(4,20,6,1,2,691041945,'2012-11-06',1,NULL,NULL,NULL,'2012-11-06 07:27:00',NULL),(5,20,8,1,1,691041945,'2012-11-06',1,NULL,NULL,NULL,'2012-11-06 07:27:00',NULL),(6,20,7,1,1,132288191,'2012-11-06',1,NULL,NULL,NULL,'2012-11-06 07:48:22',NULL),(7,20,10,1,1,975002054,'2012-11-10',1,NULL,NULL,NULL,'2012-11-10 03:47:35',NULL);
...
CREATE TABLE `boutique_users` (
  ...
  CONSTRAINT `FK_boutique_user_country` FOREIGN KEY (`country_code_id`) REFERENCES `boutique_country_codes` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=38 DEFAULT CHARSET=latin1;

/*Data for the table `boutique_users` */

insert  into `boutique_users`(`id`,`full_name`,`user_password`,`email_address`,`mobile_no`,`residence_address`,`office_address`,`country_code_id`,`is_residence_preferred_delivery_place`,`is_admin`,`is_active`,`created_at`,`modified_at`) values (1,'Mizanur Islam Laskar','d033e22ae348aeb5660fc2140aec35850c4da997','admin@domain.com','4235464564','dfsdfsdfsdgdsgf','sfdsagdf',2,0,1,1,'2012-09-29 00:00:00',NULL),(2,'Afsana Rahman','418f2789c728ef4ed96b2635b5f89f247fd1e147','sales@universalsigning.com','011-65-8123 456','Some Home Address.....','Hellooo',33,1,0,1,'2012-10-04 04:05:50','2013-01-29 12:09:41'),(3,'Salman Khan','7c4a8d09ca3762af61e59520943dc26494f8941b','salman@gmail.com','011-65-8123 456','Mumbai Home Address','DELLHI Office Address',2,1,0,0,'2012-10-04 08:20:55','2012-10-05 06:09:53'),(4,'Khaled Habib','4b48ce0c2a02e7d4277ac184f8d99ebb348c25cf','khaled@gmail.com','011-65-8123 456','Gazipur Home Address','POLAR Office Address',2,1,0,1,'2012-10-04 09:54:30','2012-10-05 07:25:32'),(5,'Mashrura Islam','bf798206ea453f4cfc4cb1b20aaac638f0ef2927','mashrura@gmail.com','011-65-8123 788','Gazipur Home Address','Some Official Address',1,1,0,1,'2012-10-05 05:57:39','2012-12-22 03:49:08'),(6,'Sazia Afrin','4c869544815205bde1f31f7b2fb09b97a22fa722','sazia@gmail.com','011-65-8123 471','Mumbai Home Address','POLAR Office Address',2,1,0,1,'2012-10-05 06:04:16',NULL),(7,'Saima Kuratul Aine','7c4a8d09ca3762af61e59520943dc26494f8941b','saima@msn.com','011-65-8123 781','Gazipur Home Address','DELLHI Office Address',2,0,0,1,'2012-10-05 06:07:20',NULL),(8,'Nafisa Kuratul Aine','20d75fe135fc3abc15aee2f6e4657c3107899d6a','nafisa@yahoo.com','011-65-8123 471','Gazipur Home Address','POLAR Office Address',2,0,0,1,'2012-10-05 06:17:25',NULL),(9,'Sabina Yesmin','7c222fb2927d828af22f592134e8932480637c0d','sabina@aol.com','011-65-8123 470','Mumbai Home Address','POLAR Office Address',2,1,0,1,'2012-10-05 06:21:39',NULL),(12,'Anushka Islam','20eabe5d64b0e216796e834f52d61fd0b70332fc','anu@gmail.com','011-65-8123 788','Gazipur Home Address','',2,0,0,1,'2012-10-05 06:29:25',NULL),(13,'Dipika Padugon','be920fdca4a28c5da65a91076b38471b31229194','dip@mns.com','011-65-8123 473','Gazipur Home Address','',2,0,0,1,'2012-10-05 06:32:28',NULL),(15,'Rishi Kapoor','7c222fb2927d828af22f592134e8932480637c0d','rishi@gmail.com','011-65-8123 477','Rangpur home','Rangpur thana',2,1,0,1,'2012-10-05 06:38:03',NULL),(16,'Some Customer','84bc185d5f04685f7031c29913bd13af35256833','customer@gmail.com','01871233','sdddd','okkiia',2,1,0,1,'2012-10-18 03:21:49',NULL),(17,'Another ANME','17111b8664066497e22d610b57eb7fac74e7f01d','someone@msn.com','0147852','sdasd','ssdfsdg',2,0,0,1,'2012-10-18 03:25:39',NULL),(18,'mizan123','06d9b5eb513d695a15a99001fed73bd552b17ca5','mizan123@msn','011-65-8123 788','jvjhbjhb','kjbkjjk',2,1,0,1,'2012-10-20 02:27:24',NULL),(19,'mizan12','7c4a8d09ca3762af61e59520943dc26494f8941b','mizan12@msn.com','011-65-8123 788','adfr','fght',2,1,0,1,'2012-10-20 02:30:24',NULL),(20,'Mizanur Islam','7d23d91e4379ccf2240d3564be0e72f42ff4b244','ruman@gmail.com','01816719318','Home Address','Office Address',1,1,0,1,'2012-10-22 05:04:36','2012-12-22 03:49:47'),(21,'Ashraf Uddoula','7c4a8d09ca3762af61e59520943dc26494f8941b','ashraf@msn.com','01747465999','Home Address','Office Address',1,0,0,1,'2012-12-22 03:53:12',NULL),(34,'Salman Khan','76c74be25ae3827c5c8bc9d24ebf87cd532d46c2','salman@aol.com','01816719318','res','off',1,0,0,1,'2012-12-26 07:08:39',NULL),(35,'Rumana Afrin','df76fb3fed9f8053357d8d46e5b528ac3c1fe2f1','rumana@aol.com','01727232666','es','off',1,1,0,1,'2012-12-26 07:26:59',NULL),(36,'Afsana Rahman','2441','sales@universalsigning.com','011-65-8123 456','Some Home Address','Some Official Address',3,1,0,0,'2013-01-29 09:05:28',NULL),(37,'Afsana Rahman','8393','sales@universalsigning.com','011-65-8123 456','Some Home Address','Some Official Address',3,1,0,0,'2013-01-29 09:10:29',NULL);
